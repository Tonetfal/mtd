...
static const UInputAction *FindInputActionForTag(
	const TArray<FMTD_InputAction> &InputActions, FGameplayTag InputTag)
{
...
const UInputAction *UMTD_InputConfig::FindNativeInputActionForTag(
	FGameplayTag InputTag) const
{
	return FindInputActionForTag(NativeInputActions, InputTag);
}

const UInputAction *UMTD_InputConfig::FindAbilityInputActionForTag(
	FGameplayTag InputTag) const
{
