...
void UMTD_ManaComponent::InitializeWithAbilitySystem(
	UMTD_AbilitySystemComponent *Asc)
{
	...
	{
		MTDS_ERROR("Mana component for owner [%s] has already been "
	...
	AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(
		UMTD_ManaSet::GetManaAttribute()).AddUObject(
			this, &ThisClass::OnManaChanged);
	AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(
		UMTD_ManaSet::GetMaxManaAttribute()).AddUObject(
			this, &ThisClass::OnMaxManaChanged);
	
	OnManaChangedDelegate.Broadcast(
		this, ManaSet->GetMana(), ManaSet->GetMana(), nullptr);
	OnMaxManaChangedDelegate.Broadcast(
		this, ManaSet->GetMaxMana(), ManaSet->GetMaxMana(), nullptr);
}
