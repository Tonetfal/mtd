...
{
	::Execute_Implementation(ExecutionParams, OutExecutionOutput,
		DamageStatics().DamageBaseDef);
}
...
{
	::Execute_Implementation(ExecutionParams, OutExecutionOutput,
		RangedDamageStatics().DamageRangedBaseDef);
}
	...
	FGameplayEffectAttributeCaptureDefinition DamageDef)
{
	...
	ExecutionParams.AttemptCalculateCapturedAttributeMagnitude(
		DamageDef, EvaluationParams, DamageBase);
