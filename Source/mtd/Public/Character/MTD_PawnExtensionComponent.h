...
public:
    ...
    /**
     * Register a delegate to call when pawn is ready to initialize. Will be immediately fired if it's already ready.
    ...
    /**
     * Register a delegate to call when ability system component is ready to initialize. Will be immediately fired if
     * it's already ready.
     * @param   Delegate: delegate to register for the event.
     */
    ...
    /**
     * Register a delegate to call when ability system component is uninitialized.
     * @param   Delegate: delegate to register for the event.
     */
