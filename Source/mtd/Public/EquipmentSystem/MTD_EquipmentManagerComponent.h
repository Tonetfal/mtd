...
#include "EquipmentSystem/MTD_EquipmentCoreTypes.h"
#include "mtd.h"
...
/**
 * Component to manage owner's equipment.
 *
 * It handles stat granting and retrieval, as well as spawning equipment actors in the world.
 */
UCLASS(BlueprintType, ClassGroup="Pawn", meta=(BlueprintSpawnableComponent))
