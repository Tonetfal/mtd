...
#include "Projectiles/MTD_ProjectileCoreTypes.h"
...
public:
	...
	void SetHomingTarget(TWeakObjectPtr<USceneComponent> Value);
	...
	TWeakObjectPtr<USceneComponent> GetHomingTarget() const;
