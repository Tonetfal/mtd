...
protected:
     ...
     * @param  SubTickTimeRemaining: How much time to continue simulating in the current sub-step, which may change as a
     * result of this function. Initial default value is: TimeTick * (1.f - Hit.Time)
     ...
     * @param  OldVelocity: Velocity at the start of the simulation update sub-step. Current Velocity may differ (as a
     * result of a bounce).
     * @param  SubTickTimeRemaining: Time remaining in the simulation sub-step. May be changed to indicate change to
     * remaining time.
     ...
     * 
     * @param  Hit: Hit result of impact causing slide. May be modified by this function to reflect any subsequent
     * movement.
     * @param  SubTickTimeRemaining: Time remaining in the tick. This function may update this time with any reduction
     * to the simulation time requested.
     * @return True if simulation of the projectile should continue, false otherwise.
     */
