...
/**
 * Singleton containing possible item drops by various foes depending on present hero classes.
 *
 ...
 *
 * The initialization and uninitialization is intended to be managed by MTD_GameInstance.
 *
 * @see UMTD_GameInstance
 */
...
private:
    ...
    using CharacterClass = TSubclassOf<AMTD_BaseFoeCharacter>;
...
private:
    ...
    /**
     * Destroy item drop manager.
     */
    static void Destroy();
    
public:
    /**
     * Get singleton instance of item drop manager.
     * @return  Singleton instance of item drop manager.
     */
...
public:
     ...
     */
    bool GetRandomItemDropList(TSubclassOf<AMTD_BaseFoeCharacter> Class,
     ...
     */
    bool GetRandomItemID(TSubclassOf<AMTD_BaseFoeCharacter> Class, int32 &OutItemID) const;
     ...
     * @param   bSort: if true, active item drops pool will be sorted, false otherwise.
     */
    void AddListInPool(TSubclassOf<AMTD_BaseFoeCharacter> Class, const UMTD_ItemDropList *ItemDropList,
        bool bSort = true);
     ...
     * @param   bSort: if true, active item drops pool will be sorted, false otherwise.
     */
    void RemoveListInPool(TSubclassOf<AMTD_BaseFoeCharacter> Class, const UMTD_ItemDropList *ItemDropList,
        bool bSort = true);
...
private:
     ...
     * @param   bSort: if true, active item drops pool will be sorted, false otherwise.
     */
    void AddListInActivePool(TSubclassOf<AMTD_BaseFoeCharacter> Class, const UMTD_ItemDropList *ItemDropList,
        bool bSort = true);
     ...
     * @param   bSort: if true, active item drops pool will be sorted, false otherwise.
     */
    void RemoveListFromActivePool(TSubclassOf<AMTD_BaseFoeCharacter> Class, const UMTD_ItemDropList *ItemDropList,
        bool bSort = true);
...
private:
    ...
    TMap<TSubclassOf<AMTD_BaseFoeCharacter>, FMTD_ItemDropListSet> ClassifiedItemDropListPool;
    ...
    TArray<TSubclassOf<AMTD_BaseFoeCharacter>> BroadcastListeners;
