...
/**
 * Attribute set that defines all the required data for weapons and abilities
 * to deal damage.
 */
UCLASS()
...
protected:
	// A constant value of damage that will be added on damage computing.
	// Must be assigned only by a Weapon Instance.
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	FGameplayAttributeData DamageBase;
	
	// A constant value of damage that will be added on damage computing.
	// Must be assigned only by a Ranged Weapon Instance.
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	FGameplayAttributeData DamageRangedBase;
	
	// A constant value of damage that will be added on damage computing.
	// Must be assigned only by an Abilitie.
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	FGameplayAttributeData DamageAdditive;
	
	// A scalar value that will be multiply damage on damage computing.
	// Must be assigned only by an Abilitie.
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
